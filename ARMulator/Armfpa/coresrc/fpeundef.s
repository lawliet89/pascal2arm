...
;
; RCS $Revision: 1.5 $
; Checkin $Date: 1997/04/22 17:01:28 $
...
; R14 in non-user modes). Note we don't care about R8 to R12 in FIQ modes.
...
; mode-dependent registers.
        ...
        MACRO
        FPE_UseOtherModeAddress
        GetMode Rtmp
        [ {CONFIG}=32
          MRS     Rtmp2,CPSR_all                ;Rtmp2 := original mode
